                            ...
                            <div class="breadcome-list single-page-breadcome">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <a href="<?= base_url()?>layout/addLayout"><button type="button" class="btn btn-success">Add Layout</button></a>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    data-click-to-select="true" data-toolbar="#toolbar">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="email" data-editable="true">Duration</th>
                                                <th data-field="phone" data-editable="true">publishedStatus</th>
                                                <th data-field="complete">Owner</th>
