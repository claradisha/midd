...
<body>
  ...
  <div class="all-content-wrapper">
    ...
    <div class="courses-area">
      <div class="container-fluid">
        <div class="row">
          <form action="<?= base_url() ?>layout/postTemplate" method="post">
            <!-- <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
              <div class="courses-inner res-mg-b-30">
                <div class="courses-title">
                  <label>
                    <input type="radio" name="test" value="big">
                    <img src="<?= base_url('assets/'); ?>img/template/full screen.png" alt="Option 2">
                  </label>
                  <h2>Full Screen</h2>
            ...
            <label>
              <input type="radio" name="templateLayout" id="templateLayout" value="fullscreen">
              <img src="<?= base_url('assets/'); ?>img/template/full screen.png" alt="Option 1">
            </label>

            <label>
              <input type="radio" name="templateLayout" id="templateLayout" value="lshapeleft">
              <img src="<?= base_url('assets/'); ?>img/template/L Shape Left.png" alt="Option 2">
            </label>

            <label>
              <input type="radio" name="templateLayout" id="templateLayout" value="lshaperight">
