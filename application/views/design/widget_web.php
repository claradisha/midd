        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.html"><img class="main-logo" src="<?= base_url('assets/'); ?>img/logo/xibologo.png" alt="" /></a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                            ...
                                                            <a href="">
                                                                <button class="btn btn-white" onclick="handleButtonClick('Calendar')">Calendar</button>
                                                            </a>
                                                            <a href="">
                                                                <button class="btn btn-white" onclick="handleButtonClick('Embed')">Embed</button>
                                                            </a>
                                                            <a href="">
                                                                <button class="btn btn-white" onclick="handleButtonClick('Media')">Media</button>
                                                            </a>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                            <label class="login2 pull-right pull-right-pro">Url Website</label>
                                                        </div>
                                                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                            <input type="text" class="form-control" id="layoutName" name="layoutname" />
                                                            <p>Please input website url that you wanna to assign</p>
